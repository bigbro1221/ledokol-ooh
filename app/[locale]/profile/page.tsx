        ...
        {resolvedSearchParams?.mustLinkGoogle === "1" && (
          <div className="mb-4 flex items-center justify-between gap-4 rounded-lg border border-red-200 bg-red-50 p-4 dark:border-red-800/50 dark:bg-red-950/40">
            ...
            <a
              ...
              className="shrink-0 rounded-md border border-red-200 px-3 py-1.5 text-[12px] font-medium text-red-800 transition-colors hover:bg-red-100 dark:border-red-700 dark:text-red-300 dark:hover:bg-red-950/60"
            >
              {ta('linkGoogleCta')}
            </a>
          </div>
