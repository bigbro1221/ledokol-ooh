...
/**
 * Shared modal listing per-period aggregates. Used by both the Surfaces card
 * and the Periods card on the campaign detail page — they're two different
 * entry points to the same drill-down view.
 */
export function PeriodSummariesModal({ open, onClose, periodSummaries }: Props) {
