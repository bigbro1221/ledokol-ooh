...
export async function renderCampaignPdf(opts: RenderOptions): Promise<Buffer> {
  ...
  try {
    ...
    const pdfOptions: PDFOptions = {
      format: 'A4',
      margin: { top: '42mm', bottom: '38mm', left: '30mm', right: '30mm' },
...
function buildHeaderTemplate(o: RenderOptions): string {
  return `
    <div style="width:100%;font-size:9px;font-family:sans-serif;color:#999;padding:0 30mm;box-sizing:border-box;">
